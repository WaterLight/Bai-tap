        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" style=" height: 350px;">
            ...
            <div class="carousel-item">
              <img class="d-block w-100" src="./public/core/image/a1.jpg" border="0"  alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./public/core/image/a2.jpg" border="0"  alt="Third slide">
            </div>
          </div>
